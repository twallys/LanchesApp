...
public class PedidoController {
    ...
    public ResponseEntity<Object> list(
            @Parameter(description = "Pagination and sorting parameters",
                    example = "{\"page\": \"0\", \"size\": \"10\", \"sort\": \"cliente,asc\"}",
                    schema = @Schema(implementation = Pageable.class))
            @PageableDefault(page = 0, size = 10, sort = "cliente", direction = Sort.Direction.ASC) Pageable pageable) {
        Page<PedidoDTO> itensPaginados = this.service.findAllPageable(pageable);
    ...
    public ResponseEntity<Object> create(@Validated @RequestBody PedidoRequestDTO dto) {
    ...
    public ResponseEntity<Object> update(@PathVariable Long id, @RequestBody PedidoRequestDTO dto) {

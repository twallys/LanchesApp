...
@Tag(name = "Ingredientes", description = "CRUD Ingredientes.")
public class IngredienteController {

    protected IngredienteService service;
    ...
    public ResponseEntity<Object> list(
        ...
        Page<IngredienteDTO> itensPaginados = this.service.findAllPageable(pageable);
    ...
    public ResponseEntity<Object> create(@Validated @RequestBody IngredienteRequestDTO dto) {
    ...
    public ResponseEntity<Object> update(@PathVariable Long id, @RequestBody IngredienteRequestDTO dto) {
